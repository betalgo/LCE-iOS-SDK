...
public class LaserCatEyes: NSObject {
    ...
    public static let shared = LaserCatEyes()
    ...
    public func startLogging(appKey: String, enviroment: String? = nil, appName: String? = nil) {
        self.appKey = appKey
